...
def qlearning(model, alpha=0.5, epsilon=0.1, maxiter=100, maxeps=1000):
    ...
    for i in range(maxeps):
        ...
        total_steps = 0  # initialize total_steps here
        total_rewards = 0  # initialize total_rewards here
        ...
        for j in range(maxiter):
            ...
            if np.any(state == model.goal_states_seq):
                break
        total_steps_per_episode.append(int(total_steps))
        total_rewards_per_episode.append(int(total_rewards))
